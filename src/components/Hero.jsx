...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className=" h-full overflow-hidden w-[50%] md:hidden block">
      <Spline className=" h-[800px] w-[500px] md:hidden block" scene="https://prod.spline.design/rFMMkrryCcp0Ebgq/scene.splinecode" />
      </div>
